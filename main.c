        ...
        if(!(strcmp(v->Num, vtest->Num)))
        {
            ...
            do{
                ...
                case 4:
                    ...
                    break;
                case 5:
                    printf("nombre de place disponible: ");
...
void aff_voy(voy* v)
{
    ...
    if(!bool)
    {
        printf("#ce voyage n'existe pas verifiez vous !!\n");
    }
    main();
}
...
void modify_voy(voy* v)
{
    ...
    if(bool)
    {
        ...
        printf("#ce voyage n'existe pas encore !! \n");
    }
    main();
}
...
int existed_voy(voy* v)
{
    ...
    if(!(strcmp(date1,date2))){
        while(fread(v, sizeof(voy), 1, f) == 1)
        {
            res1 = cmpdate(v->date_depart,date1);
            if(res1 ==0)
            {
                affiche_voy(v);
                bool = 1;
        ...
        while(fread(v, sizeof(voy), 1, f) == 1)
        {
            res1 = cmpdate(v->datedepart,date1);
            res2 = cmpdate(v->datedepart,date2);
            if((res1 >= 0) &&  (res2 <= 0))
            {
                affiche_voy(v);
                bool = 1;
